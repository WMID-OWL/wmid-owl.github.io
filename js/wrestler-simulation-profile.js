(() => {
    ...
    function makeBuildItem(
        ...
        function parameterRatingPoints(
        reference,
        rating
    ) {
    ...
    function calculateParameterCost(
        profile,
        reference
    ) {
    ...
    function renderSimulationSkills(
        ...
        auditSection.className =
            "owl-sim-build-group owl-sim-audit";
        ...
        [
            [
                ...
                total === baseline
                    ? "BASELINE"
                    : `${total - baseline >= 0 ? "+" : ""}${total - baseline} FROM BASE`
            ],
